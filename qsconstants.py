...
SCHEMAS = {
    ...
    "members": "CREATE TABLE members (uid TEXT PRIMARY KEY NOT NULL UNIQUE, username TEXT NOT NULL UNIQUE, money INT NOT NULL, daily TEXT, notifs TEXT, items TEXT);",
    "ball": "CREATE TABLE ball (username TEXT PRIMARY KEY NOT NULL UNIQUE, compliment INT, insult INT);",
    ...
    "jokes": "CREATE TABLE jokes (id INT PRIMARY KEY AUTOINCREMENT NOT NULL UNIQUE, joke TEXT NOT NULL);",
    "compliments": "CREATE TABLE compliments (id INT PRIMARY KEY AUTOINCREMENT NOT NULL UNIQUE, compliment TEXT NOT NULL);",
    ...
    "bot": "CREATE TABLE bot (request TEXT PRIMARY KEY NOT NULL UNIQUE, response TEXT, image TEXT, paymin INT, paymax INT, cooldown INT, lastused INT, negresponse TEXT, bad TEXT);",
    "shop": "CREATE TABLE shop (item TEXT PRIMARY KEY NOT NULL UNIQUE, description TEXT, price INT);"
}
