...
SCHEMAS = {
    ...
    "jokes": "CREATE TABLE jokes (id SERIAL PRIMARY KEY NOT NULL UNIQUE, joke TEXT NOT NULL);",
    "compliments": "CREATE TABLE compliments (id SERIAL PRIMARY KEY NOT NULL UNIQUE, compliment TEXT NOT NULL);",
